...
@Component({
  selector: 'app-literacy-tutor',
  templateUrl: './literacy-tutor.component.html',
  styleUrls: ['./literacy-tutor.component.css']
})
export class LiteracyTutorComponent implements OnInit {
