...
@Component({
  selector: 'app-therapy-tools',
  templateUrl: './therapy-tools.component.html',
  styleUrls: ['./therapy-tools.component.css']
})
export class TherapyToolsComponent implements OnInit {
